...
void part4() {
    ...
    // Q4: Once we are finished with malloc-ed memory, we
    // need to free the memory associated with it.
    // Run "valgrind ./lab0 4" after compiling the program,
    // both with (Q4.1) and without (Q4.2) the free statement below.
